...
#Importaciones para cargar las variables de entorno
import os
from pathlib import Path
...
SECRET_KEY = 'django-insecure-%i387768+t*p717mcte2)*p1i3e_kqlw#%4571@#5^ad%7y&@='
...
#------------------------------------------------------------------------------------------------------------------
#Practica de los usuarios para iniciar, resgistrar y cerrar sesion
